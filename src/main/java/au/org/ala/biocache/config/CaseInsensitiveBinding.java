...
public class CaseInsensitiveBinding {
     ...
     */
    @Value("${case.insensitive.dto.list:GetMap,GetFeatureInfo,GetImage,GetLegendGraphic,GetMetadata,GetOgc,SpatialSearchRequestParams,DownloadRequestParams,SearchRequestParams}")
        ...
        for (String className : classNames.split(",")) {
            ...
            try {
                ...
                try {
                    ...
                    logger.error("Failed to find class with name '" + className + "' or 'au.org.ala.biocache.dto." + className + "'.");
                    continue;
                }
            }
